                    ...
                    {filtered.map((it) => (
                      <tr key={it.id} className="hover:bg-muted/30 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <Badge variant={it.itemType === "INSUMO" ? "default" : "secondary"} className="text-[10px]">
                            {it.itemType === "INSUMO" ? "Insumo" : "Servicio"}
                          </Badge>
                        </td>
                        <td className="px-4 py-3 text-muted-foreground">{categoryLabels[it.category] ?? it.category}</td>
